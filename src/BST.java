...
public class BST {
    ...
    public void insert(int item)
    {
        ...
        else if (item <= this.root) {this.left.insert(item);}
    ...
    public void delete(int item) {
        ...
        {
            if (item == this.root) {this.deleteRoot();}
            else if (item < this.root) {this.left.delete(item);}
            else {this.right.delete(item);}
        }
    }
    ...
    private void deleteRoot() {
        ...
        else {this.root = this.left.extractMax();}
    }


    private int extractMax() {
        // There could be assignment issues!
        if (this.right.isEmpty())
        {
            int max = this.root;
            BST lft = this.left.left;
            BST rght = this.right.right;
            this.root = this.left.root;
            this.left = lft;
            this.right = rght;
            return max;
    ...
    {
        if (this.isEmpty()) {return 0;}
        else if (this.root > item) {return this.left.count(item);}
        else if (this.root == item) {return 1 + this.left.count(item) + this.right.count(item);}
        else {return this.right.count(item);}
    ...
    {
        if (this.isEmpty()) {return 0;}
        else {return 1 + this.left.getSize() +  this.right.getSize();}
    }
